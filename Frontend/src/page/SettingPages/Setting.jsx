...
function Setting({ user }) {
  ...
  return (
    <div className="kanit-regular settings-page-wrapper modal-open">
      <Container fluid className="h-100 d-flex flex-column">
        <Row className="flex-grow-1 h-100">
          ...
          <Col
            md={3}
            lg={3}
            className="custom-vertical-divider pe-0 py-4 scrollable-col settings-sidebar"
          >
          ...
          <Col
            md={9}
            lg={9}
            className="ps-md-5 py-4 scrollable-col bg-transparent"
          >
    ...
    <div style={{ padding: "1rem 0" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          <i
            className={`bi ${theme === "light" ? "bi-sun" : "bi-moon-stars-fill"}`}
            ...
            style={{
              ...
              color:
                theme === "light"
                  ...
                  : "var(--text-muted)",
              background:
                theme === "light" ? "var(--primary-light)" : "var(--bg-hover)",
            }}
          >
            สว่าง
          </div>
        ...
        >
          ...
          <div
            style={{
              ...
              fontSize: "0.85rem",
              color:
                theme === "dark" ? "var(--primary-color)" : "var(--text-muted)",
              background:
                theme === "dark" ? "var(--primary-light)" : "var(--bg-hover)",
            }}
          >
            มืด
          </div>
