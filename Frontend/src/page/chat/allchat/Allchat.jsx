                            ...
                            <>
                                {assignedMember.image ? (
                                    ...
                                    <div 
                                        ...
                                        style={{ width: "20px", height: "20px", borderRadius: "50%", flexShrink: 0, backgroundColor: getAvatarColor(assignedMember.username), fontSize: "10px", fontWeight: "600" }}
                                    >
                    ...
                    <Dropdown drop="end" className="w-100" show={openSubMenu === 'assignee'}>
                        ...
                        <Dropdown.Menu className="border-0 shadow-sm" style={{ backgroundColor: "var(--bg-surface)", border: "1px solid var(--border-medium, #e5e7eb)", maxHeight: "200px", overflowY: "auto" }}>
                            ...
                            {members.map((m) => (
                                ...
                                >
                                    {m.image ? (
                                        <img src={m.image} alt="" style={{ width: "20px", height: "20px", borderRadius: "50%", marginRight: "8px", objectFit: "cover" }} />
                                    ) : (
                                        <div 
                                            className="d-flex align-items-center justify-content-center text-white"
                                            style={{ width: "20px", height: "20px", borderRadius: "50%", marginRight: "8px", flexShrink: 0, backgroundColor: getAvatarColor(m.username), fontSize: "10px", fontWeight: "600" }}
                                        >
