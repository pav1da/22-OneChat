    ...
    return (
        <div style={pageStyle}>
            ...
            <Card style={{
                ...
                <Card.Body>
                    <Container className="text-center" style={{ maxWidth: '380px' }}>
                        <h1 className="fw-bold mb-3" style={{ color: '#F26623' }}>ONE CHAT</h1>
                        <p className="fs-5 text-dark mb-1">Sign In</p>
                        <p className="text-muted mb-4">to continue to your One Chat account.</p>

                        {/* ผูก Form เข้ากับฟังก์ชัน handleSignIn โดยใช้ onSubmit  */}
                        <Form className="d-grid gap-3" onSubmit={handleSignIn}>
                            <Form.Group>
                                <Form.Control
                                    type="email"
                        ...
                        <p className="mt-4">
                            ...
                            <Link to="/signup" className="fw-bold text-decoration-underline ms-1" style={{ color: '#F26623' }}>
                                Sign up
                            </Link>
                        </p>
                    </Container>
