...
function AiMain({ onNavigate }) { // รับ props onNavigate
    ...
    return (
        <div className="px-3 pt-5 mt-3" style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div className="mb-4">
                <h5 className="mb-2 fs-5" style={{ fontSize: '1.1rem' }}>AI Chat</h5>
            ...
            <div className="d-flex justify-content-between align-items-center border rounded-3 p-3 mb-3 bg-white">
                <div>
                    <h6 className="mb-1" style={{ fontSize: '1rem' }}>ข้อความตอบกลับอัตโนมัติ</h6>
            ...
            <div className="d-flex justify-content-between align-items-center border rounded-3 p-3 mb-3 bg-white">
                <div>
                    <h6 className="mb-1 " style={{ fontSize: '1rem' }}>คำตอบเริ่มต้น</h6>
            ...
            <div className="d-flex justify-content-between align-items-center">
                <h6 className="mb-0" style={{ fontSize: '1rem' }}>ระบบ AI ตอบแชทอัตโนมัติ</h6>
