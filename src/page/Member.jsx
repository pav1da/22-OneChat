      ...
      <div className="d-flex flex-column gap-3 mb-5">
        {teams.map((team) => {
          const membersInTeam = allMembers
            .filter((u) => u.team?.toLowerCase() === team.name.toLowerCase())
            .sort((a, b) => (a.role === "หัวหน้า" ? -1 : 1));
            ...
            >
              ...
              >
                <div className="px-3">
                  ...
                  <div className="text-muted fs-6 py-1">
      ...
      <div className="d-flex flex-column pb-5">
        {displayMembers.map((member) => (
          ...
          >
            ...
            <div style={{ width: "25%" }}>{member.team}</div>

            <div style={{ width: "25%" }} className="text-uppercase">
              {member.role}
            </div>

            <div style={{ width: "25%" }}>{member.status}</div>
