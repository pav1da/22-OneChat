...
import { Container, Button, Form, Col, Row, Dropdown, Modal } from "react-bootstrap";
...
const Cardmessage = () => {
  ...
  return (<div className="main-content flex-grow-1 p-3 kanit-regular bg-white rounded-4">
    ...
    <div className="d-flex justify-content-between align-items-center mt-3 ">
      <div className="fs-6 fw-regular ms-3 mt-3">
        เทมเพลตทั้งหมด
      </div>
    ...
    <Modal show={show} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <Modal.Title>สร้าง Card / Message</Modal.Title>
      </Modal.Header>
